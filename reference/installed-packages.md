...
**Package:** `packages/nla-penny-post/`
...
- Added `reference/feedback-log.md` and `packages/nla-penny-post/` to the Key Files table in `CLAUDE.md`
...
- Created `.claude/skills/check-feedback/SKILL.md` — thin wrapper delegating to `packages/nla-penny-post/app/check-feedback.md`
- Created `.claude/skills/write-letter/SKILL.md` — thin wrapper delegating to `packages/nla-penny-post/app/write-letter.md`

---

## process helpers

**Source:** `packages/nla-process-helpers/`
...
|-------------|------------------|--------------|
| `CLAUDE-intent.md` | `CLAUDE.md` | Added `/unpack` to Available Skills table. Key files reference for `packages/nla-process-helpers/` was already present. |
| `skills-intent.md` | `.claude/skills/unpack/` | Created thin wrapper delegating to `packages/nla-process-helpers/app/unpack.md` |
...
| `skills-intent.md` | Added wrapper definitions for 3 new skills | Created thin wrappers: `.claude/skills/brainstorm-cluster/SKILL.md`, `.claude/skills/steelman/SKILL.md`, `.claude/skills/devils-advocate/SKILL.md` — all delegating to `packages/nla-process-helpers/app/[name].md` |
